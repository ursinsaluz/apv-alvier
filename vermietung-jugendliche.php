...
?>
        <div class="container pb-5 pt-5" id="content">
            <div class="row" data-pgc-field="Titel">
                <h2>Vermietung für Vereine und Schulen</h2>
            </div>
            <div class="row">
...
Probier&rsquo;s einfach aus, wir freuen uns auf deine Anfrage!</p>
                        <p><button type="button" class="btn btn-primary">
                                <a href="https://app.heimv.ch/apv-alvier/homes/8/occupancies/embed?display_months=9" target="_blank">Jetzt reservieren</a>
                            </button></p>
                    </section>
                    <section class="pb-3 pt-3">
                        <h2>Informationen</h2>
                        <img src="images/jugendliche.png" class="img-fluid pb-4">
                        <p>Für Treffen, Kurse, Events oder Lager ist unser Pfadiheim die beste Wahl. Das Haus ist luxuriös ausgestattet und bietet eine komplette Infrastruktur für max. 60 Personen. Geeignete Übernachtungsmöglichkeiten mit getrennten WC- und Duschanlagen für max. 42 Personen sind im OG  vorhanden. Ebenfalls gibt&rsquo;s einen Raum für Vorbereitungsarbeiten. Im EG befinden sich Eingangsbereich, Aufenthaltsraum, WCs, Materialraum und eine grosse Küche.</p>
                        <p>Für Aktivitäten im Freien eignet sich der überdachte Sitzplatz mit Aussengrill und den Festbankgarnituren.  Die Aussenarena mit Feuerschale bietet sich nicht nur zum Würste braten an, sondern auch für stimmungsvolle, abendliche Zusammenkünfte bei offenem Feuer. Für Sport, Spiel und Spass eignet sich die Wiese vor dem Heim hervorragend und der angrenzende Wald bietet viel Raum für Naturerlebnisse und spannende Abenteuer.</p>
                    </section>
                </div>
                <div class="col-md-4">
                                ...
                                <div class="col-md-12" data-pgc-field="downloads"> 
                                    <section>
                                        <div class="px-3">
                                            ...
                                            <p><a href="downloads/Tarife/Tarife_Vereine_und_Schulen.pdf" target="_blank">Tarife</a><br><a href="downloads/Heimordnung_Schneggeboedeli.pdf" target="_blank">Heimordnung</a><br><a href="downloads/Grundriss_Schneggeboedeli.pdf" target="_blank">Grundriss</a><br><a href="downloads/Kuecheninventar_Pfadiheim.pdf" target="_blank">Kücheninventar</a></p>
                                            <p></p> 
                                        </div>
                                    </section>
                                </div>
